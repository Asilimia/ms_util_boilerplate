...
def get_settings() -> BackendBaseSettings:
    """
    The function `get_settings` returns an instance of `BackendBaseSettings` based
    on the value of the `ENVIRONMENT` environment variable, with a default value of
    "DEV".
    :return: an instance of the `BackendBaseSettings` class.
    """
